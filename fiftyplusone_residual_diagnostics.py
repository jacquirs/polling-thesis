...
log_file = open('output/fiftyplusone_residual_diagnostics_log.txt', 'w')
sys.stdout = log_file

print("="*110)
print("COMPREHENSIVE RESIDUAL DIAGNOSTICS, NO PARTISAN CONTROL")
print("="*110)
...
reg_df_exploded = pd.read_csv('data/harris_trump_datelimted_regression.csv')
...
plt.tight_layout()
plt.savefig("figures/fiftyplusonePY/datelimited/residual_diagnostics_main.png", dpi=300)
plt.close()

print("visual diagnostics saved to: figures/fiftyplusonePY/datelimited/residual_diagnostics_main.png")
print("numerical diagnostics saved to: output/fiftyplusone_residual_diagnostics_log.txt")