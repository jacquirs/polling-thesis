...
###### USE NO EXPLODE, SHOULDNT MAKE A DIFFERENCE


# redirect all print output to a log file
log_file = open('output/fiftyplusone_datelimited_simple_mode_analysis_log_no_explode.txt', 'w')
sys.stdout = log_file
...
df_threeway = pd.read_csv('data/harris_trump_datelimited_simple_mode_analysis_threeway_no_explode.csv')

# load the pure binary dataset
df_pure = pd.read_csv('data/harris_trump_datelimited_simple_mode_analysis_pure_no_explode.csv')
