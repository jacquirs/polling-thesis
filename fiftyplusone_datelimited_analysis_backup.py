...
log_file = open('output/fiftyplusone_analysis_datelimited_log1.txt', 'w')
sys.stdout = log_file
...
axes[1, 0].hist(national_polls['pct_trump_poll'].dropna(), bins=30,
                edgecolor='black', alpha=0.7, color='red')
axes[1, 0].axvline(true_trump_national, color='darkred', linestyle='--', linewidth=2)
axes[1, 0].axvline(national_polls['pct_trump_poll'].mean(), color='black', linestyle='--', linewidth=2)
...
axes[1, 0].set_title('Trump Poll Distribution', fontsize=title_fs, fontweight='bold')
axes[1, 0].tick_params(axis='both', labelsize=tick_fs)

axes[1, 1].hist(national_polls['pct_harris_poll'].dropna(), bins=30,
                edgecolor='black', alpha=0.7, color='blue')
axes[1, 1].axvline(true_harris_national, color='navy', linestyle='--', linewidth=2)
axes[1, 1].axvline(national_polls['pct_harris_poll'].mean(), color='black', linestyle='--', linewidth=2)
...
axes[1, 1].set_title('Harris Poll Distribution', fontsize=title_fs, fontweight='bold')
...
axes[1, 2].hist(national_polls['pct_trump_poll'] - national_polls['p_trump_true']*100,
                bins=50, alpha=0.5, color='red', edgecolor='black')
axes[1, 2].hist(national_polls['pct_harris_poll'] - national_polls['p_harris_true']*100,
                bins=50, alpha=0.5, color='blue', edgecolor='black')
...
axes[1, 2].set_title('Errors', fontsize=title_fs, fontweight='bold')
axes[1, 2].tick_params(axis='both', labelsize=tick_fs)

plt.suptitle('National Polls Only', fontsize=20, fontweight='bold', y=0.98)
...
axes[1, 0].set_xlabel('Trump Poll %', fontsize=label_fs, fontweight='bold')
axes[1, 0].set_ylabel('Frequency', fontsize=label_fs, fontweight='bold')
axes[1, 0].set_title('Trump Poll Values',
                    fontsize=title_fs, fontweight='bold')
axes[1, 0].tick_params(axis='both', labelsize=tick_fs)
...
axes[1, 1].set_xlabel('Harris Poll %', fontsize=label_fs, fontweight='bold')
axes[1, 1].set_ylabel('Frequency', fontsize=label_fs, fontweight='bold')
axes[1, 1].set_title('Harris Poll Values',
                    fontsize=title_fs, fontweight='bold')
axes[1, 1].tick_params(axis='both', labelsize=tick_fs)
...
# FIX: give space for title so it doesn't overlap
plt.suptitle('National Polls Only', fontsize=20, fontweight='bold')
...
# same font sizes except legend smaller
title_fs = 16
label_fs = 16
tick_fs = 13
legend_fs = 11
...
axes[1, 0].set_ylabel('Frequency', fontsize=label_fs, fontweight='bold')
axes[1, 0].set_title('Harris Poll Distribution', fontsize=title_fs, fontweight='bold')
axes[1, 0].tick_params(axis='both', labelsize=tick_fs)
...
axes[1, 1].set_ylabel('Frequency', fontsize=label_fs, fontweight='bold')
axes[1, 1].set_title('Trump Poll Distribution', fontsize=title_fs, fontweight='bold')
axes[1, 1].tick_params(axis='both', labelsize=tick_fs)
...
plt.suptitle('Battleground States Combined', fontsize=20, fontweight='bold', y=0.98)
plt.tight_layout(rect=[0, 0, 1, 0.94])
...
# EXACT same font sizes as national
title_fs = 16
label_fs = 14
tick_fs = 13
legend_fs = 13
...
axes[0, 2].hist(bg_polls['A'].dropna(), bins=50,
                edgecolor='black', alpha=0.7, color='green')
axes[0, 2].axvline(bg_polls['A'].mean(), color='darkgreen',
                   linestyle='--', linewidth=2,
                   label=f'Mean: {bg_polls["A"].mean():.4f}')
...
axes[1, 0].hist(bg_polls['pct_trump_poll'].dropna(), bins=30,
                edgecolor='black', alpha=0.7, color='red')
axes[1, 0].axvline(mean_true_trump, color='darkred',
                   linestyle='--', linewidth=2,
                   label=f'Mean True: {mean_true_trump:.2f}%')
axes[1, 0].axvline(bg_polls['pct_trump_poll'].mean(), color='black',
                   linestyle='--', linewidth=2,
...
axes[1, 1].hist(bg_polls['pct_harris_poll'].dropna(), bins=30,
                edgecolor='black', alpha=0.7, color='blue')
axes[1, 1].axvline(mean_true_harris, color='navy',
                   linestyle='--', linewidth=2,
                   label=f'Mean True: {mean_true_harris:.2f}%')
axes[1, 1].axvline(bg_polls['pct_harris_poll'].mean(), color='black',
                   linestyle='--', linewidth=2,
...
axes[1, 2].hist(trump_error_all.dropna(), bins=50, alpha=0.5,
                color='red', edgecolor='black', label='Trump Error')
axes[1, 2].hist(harris_error_all.dropna(), bins=50, alpha=0.5,
                color='blue', edgecolor='black', label='Harris Error')
axes[1, 2].axvline(0, color='black', linewidth=1)
axes[1, 2].set_xlabel('Simple Error', fontsize=label_fs, fontweight='bold')
axes[1, 2].set_ylabel('Frequency', fontsize=label_fs, fontweight='bold')
axes[1, 2].set_title('Errors', fontsize=title_fs, fontweight='bold')
...
plt.suptitle('Trump Component by State', fontsize=16)
plt.tight_layout()
