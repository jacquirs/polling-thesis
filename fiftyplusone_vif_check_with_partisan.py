...
log_file = open('output/fiftyplusone_vif_diagnostics_with_partisan_log.txt', 'w')
sys.stdout = log_file

print("="*110)
print("MULTICOLLINEARITY DIAGNOSTICS (VIF), WITH partisan control")
print("source data: data/harris_trump_regression_original_with_partisan.csv")
print("="*110)
