...
if __name__ == '__main__':
    ...
    print(f"kalman filtering & smoothing analysis — within-day aggregated version")
    ...
    for days_before in TIME_WINDOWS:
        ...
        plot_results(df_anchored, anchored=True, 
                    save_path=f'figures/kalman_agg_bias_anchored_{window_label}.png')
        export_results(df_anchored, 
                      out_path=f'data/kalman_agg_results_anchored_{window_label}.csv')
        ...
        plot_results(df_unanchored, anchored=False, 
                    save_path=f'figures/kalman_agg_trajectory_unanchored_{window_label}.png')
        export_results(df_unanchored, 
                      out_path=f'data/kalman_agg_results_unanchored_{window_label}.csv')
