...
log_file = open('output/fiftyplusone_residual_diagnostics_with_partisan_and_lv_log.txt', 'w')
sys.stdout = log_file

print("="*110)
print("COMPREHENSIVE RESIDUAL DIAGNOSTICS, WITH PARTISAN AND LV CONTROL")
print("="*110)
...
reg_df_original = pd.read_csv('data/harris_trump_regression_original_with_partisan_and_lv.csv')
...
reg_df_exploded = pd.read_csv('data/harris_trump_datelimted_clustertwoway_with_partisan_and_lv_regression.csv')
...
plt.tight_layout()
plt.savefig("figures/fiftyplusonePY/datelimited/residual_diagnostics_main_with_partisan_and_lv.png", dpi=300)
plt.close()

print("visual diagnostics saved to: figures/fiftyplusonePY/datelimited/residual_diagnostics_main_with_partisan_and_lv.png")
print("numerical diagnostics saved to: output/fiftyplusone_residual_diagnostics_with_partisan_and_lv_log.txt")